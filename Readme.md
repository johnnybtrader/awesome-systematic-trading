...
- [WatchCrypto](https://watchcrypto.io) - Real-time crypto charts with 1-second candles, full-depth order books and trade tapes from Binance, Bybit, Coinbase, Kraken and Hyperliquid, plus live Hyperliquid funding rates. Free, no sign-up required.
